...
class LikedNewsListViewController: UIViewController {
    private let tableView = UITableView()
    private let viewModel = LikedNewsViewModel()
...
extension LikedNewsListViewController: UITableViewDelegate, UITableViewDataSource {
